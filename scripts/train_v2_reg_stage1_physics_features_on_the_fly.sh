...
NUM_GPUS=1                                   # the paper used 4 GPUs for pre-training

python tabicl/train/_run.py \
            --wandb_log False \
            --wandb_project TabICLv2 \
            --wandb_name tabiclv2_reg_physics_features_stage1 \
            --device cuda \
            --dtype float32 \
            --np_seed 43 \
            --torch_seed 43 \
            ...
            --fct_types mix_physics \
            --physics_ancestor_boost_prob 0.3 \
            --prior_device cpu \
            --n_jobs 16 \
            --batch_size_per_gp 4 \
            --min_features 1 \
            ...
            --checkpoint_dir ~/Programming/forks/tabicl/checkpoints/physics_features_regression/stage_1 \
            --save_temp_every 500 \
